from ..bridge_2 import BRIDGE_2
from tbears.libs.scoretest.score_test_case import ScoreTestCase


class TestBRIDGE_2(ScoreTestCase):

    def setUp(self):
        super().setUp()
        self.score = self.get_score_instance(BRIDGE_2, self.test_account1)
    ...
    def test_relay_and_verify_by_part(self):
        # derive app_hash
